function Home( { topojson } ) {
    ...
    return (
        <div className="welcome">
            ...
            <div>
                <span className="symbol">&#9657;</span> Για την ανάπτυξη του κώδικα χρησιμοποιήθηκε το Next.js (React framework), τα γεωγραφικά δεδομένα προέρχονται από τα ανοικτά δεδομένα που διατίθενται στο geodata.gov.gr, ενώ πληροφορίες συμπληρώθηκαν και από το el.wikipedia.org.
            </div>
            <div>
