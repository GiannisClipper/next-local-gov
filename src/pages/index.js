function Home( { topojson } ) {
    ...
    return (
        <div className="welcome">
            ...
            <div>
                <span className="symbol">&#9657;</span> Σκοπός της υλοποίησης ήταν η εκμάθηση και η πρρακτική άσκηση σε τεχνολογίες ανάπτυξης web εφαρμογών και ιστοσελίδων, καθώς κα τη χρήση γεωγραφικών δεδομένων και τη γραφική απεικόνισή τους.
            </div>
            <div>
